...
[![CI](https://github.com/sweetrpg/model-core.go/actions/workflows/go-ci.yml/badge.svg)](https://github.com/sweetrpg/model-core.go/actions/workflows/go-ci.yml)
...
Documentation for this package can be found [here](https://sweetrpg.github.io/model-core.go).
