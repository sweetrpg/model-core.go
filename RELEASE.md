...
1. Trigger the [**Prepare Release**](https://github.com/sweetrpg/model-core.go/actions/workflows/prepare-release.yaml) workflow.
...
Trigger the [**Prepare Release**](https://github.com/sweetrpg/model-core.go/actions/workflows/prepare-release.yaml) workflow (`workflow_dispatch` in the Actions tab). It:
...
[**PR Validation**](https://github.com/sweetrpg/model-core.go/actions/workflows/pr.yaml)
workflow runs against it - merge into `master`, which triggers tagging via the
[**Tag Release**](https://github.com/sweetrpg/model-core.go/actions/workflows/tag-release.yaml)
workflow.

The tag push triggers the
[**Release**](https://github.com/sweetrpg/model-core.go/actions/workflows/release.yaml)
...
Or trigger it directly from the [Prepare Release workflow page](https://github.com/sweetrpg/model-core.go/actions/workflows/prepare-release.yaml), selecting `develop` from the branch dropdown.
